...
struct SoundTouchProcessor::Impl {
    ...
    void applyLowLatencySettings() {
        if (lowLatency) {
            // Low-latency profile: sequence = 20ms, seek window = 8ms, overlap = 4ms, quickseek = true
            // Pipeline latency ~28ms at 44.1kHz (< 30ms requirement) - tuned for SoundTouch 2.3.x sampleReq
