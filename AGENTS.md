...
This project is indexed by GitNexus as **reals-lab-extension** (586 symbols, 502 relationships, 188 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
