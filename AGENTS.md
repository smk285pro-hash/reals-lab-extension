...
This project is indexed by GitNexus as **reals lab extension** (2451 symbols, 5677 relationships, 176 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
